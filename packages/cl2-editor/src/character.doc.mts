...
export class CharacterDocument {
  ...
  async save(content: string) {
    ...
    await updateChangesFromParsedCharacter(this.parseResults.parsed, this.mote.id, this.packed);
  ...
  static from(uri: vscode.Uri, workspace: CrashlandsWorkspace) {
    ...
    assertInternalClaim(isCharacterMote(mote), 'Only Characters are supported.');
